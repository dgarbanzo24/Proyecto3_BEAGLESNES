...
#if 1 /* BeagleSNES */
/* Blitters for tiny displays (like capes) */
void S9xBlitPixSimpleHalfxHalf (uint8 *, int, uint8 *, int, int, int);
void S9xBlitPixSimple1xHalf (uint8 *, int, uint8 *, int, int, int);
void S9xBlitPixSimpleHalfx1 (uint8 *, int, uint8 *, int, int, int);
/* Blitter for ARM */
void S9xBlitPixARM2x2 (uint8 *, int, uint8 *, int, int, int);
#endif /* BeagleSNES */
#endif
